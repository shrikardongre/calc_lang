...
namespace {
    class DeclCheck: public ASTVisitor{
        ...
        // What is a llvm::StringSet ? 
        // StringSet is essentially a set implemented on top of a hash table.
        /*
        Here Scope.insert(value) will return std::pair<iterator, bool>

        .first → iterator to the element in the set.
        .second → true if insertion happened, false if it was already present.
        ...
        */
        ...
        // For a binaryOp node we should just check if both the sides are present and visited.
